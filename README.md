...
dhcp-server {
         shared-network-name DMZ_POOL {
             subnet 192.168.7.0/24 {
                 ...
                 static-mapping static1 {
                     ip-address 192.168.7.100
                     mac-address 00:0c:29:ae:d1:f5
                 }
             }
         }
         shared-network-name INTERNAL_POOL {
             subnet 10.7.0.0/24 {
...
```
Prav ti dve pravili skrbita za komunikacijo z javnim internetom.
